...
//                 <div className="mb-3 pb-1">
//                     <label htmlFor="locationLongitude" className="form-label">Longitude</label>
//                     <input type="number" className="form-control" id="locationLongitude" name="locationLongitude" value={props.record.locationLongitude} onChange={handleChangeRecord} readOnly/>
//                 </div>
//             </div>
//             <div className="col-sm-6">
//                 <div className="mb-3 pb-1">
//                     <label htmlFor="locationLatitude" className="form-label">Latitude</label>
//                     <input type="number" className="form-control" id="locationLatitude" name="locationLatitude" value={props.record.locationLatitude} onChange={handleChangeRecord} readOnly/>
//                 </div>
//             </div>
...
//                 <div className="mb-3 pb-1">
//                     <label htmlFor="location" className="form-label">Location</label>
//                     <input type="text" className="form-control" id="location" name="location" value={props.record.location} onChange={handleChangeRecord} required />
//                 </div>
//             </div>
            
//                 {/* <div className="mb-3">
//                     <label htmlFor="quantity" className="form-label">Quantity :</label>
//                     <input type="text" className='form-control' id="quantity" name="quantity" value={props.record.quantity} onChange={handleChangeRecord} required readonly/>
//                 </div> */}
...
//                 <input type="text" className="form-control" id="notes" name="notes" value={props.record.notes} onChange={handleChangeRecord} />
//             </div>
