...
return (
<>
<h5><FontAwesomeIcon icon="pencil" /> Edit User</h5>

<div className="table center">

<form onSubmit={handleSubmit} autoComplete="off">
<div className="mb-3 pb-1">
    <label htmlFor="firstName" className="form-label">Users First Name</label>
    <input className="form-control" id="firstName" name="firstName" type="text" onChange={handleChange} value={user.firstName} required />
</div>
<div className="mb-3 pb-1">
    <label htmlFor="lastName" className="form-label">Users Last Name</label>
